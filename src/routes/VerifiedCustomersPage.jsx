  ...
  return (
    <div className="flex flex-col gap-y-4 p-4">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-2xl font-bold">Verified Customers</h1>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-lg border bg-white p-4 dark:bg-slate-800">
          ...
          <p className="text-sm text-green-600">92% of customers</p>
        </div>
        <div className="rounded-lg border bg-white p-4 dark:bg-slate-800">
          <p className="text-sm text-gray-600 dark:text-gray-400">Pending Verification</p>
          <p className="text-2xl font-bold">74</p>
          <p className="text-sm text-yellow-600">8% of customers</p>
        </div>
        <div className="rounded-lg border bg-white p-4 dark:bg-slate-800">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b bg-gray-50 dark:bg-slate-700">
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Customer</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Verification Date</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Method</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-500 dark:text-gray-400">Last Purchase</th>
            ...
            <tbody className="divide-y">
              {verifiedCustomers.map((customer) => (
                <tr key={customer.id} className="hover:bg-gray-50 dark:hover:bg-slate-700">
                  ...
                  <td className="px-6 py-4">{customer.verifiedDate}</td>
                  <td className="px-6 py-4">{customer.verificationMethod}</td>
                  <td className="px-6 py-4">{customer.lastPurchase}</td>
                  <td className="px-6 py-4">{customer.totalSpent}</td>
                  <td className="px-6 py-4">
                    <span className="flex items-center gap-x-2 text-green-600">
                      <CheckCircle size={18} />
                      Verified
                    </span>
                  </td>
